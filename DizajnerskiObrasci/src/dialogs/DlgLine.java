...
public class DlgLine extends JDialog {
	...
	public DlgLine() {
		...
		{
			lblxCoordinateInitial = new JLabel("X coordinate of start point");
			lblxCoordinateInitial.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		}
		{
			...
			txtxCoordinateInitial.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		{
			lblyCoordinateInitial = new JLabel("Y coordinate of start point");
			lblyCoordinateInitial.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		}
		{
			...
			txtyCoordinateInitial.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		{
			lblxCoordinateLast = new JLabel("X coordinate of end point");
			lblxCoordinateLast.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		{
			lblyCoordinateLast = new JLabel("Y coordinate of end point");
			lblyCoordinateLast.setFont(new Font("Tahoma", Font.PLAIN, 13));
	...
	public void write(Line line) {
		txtxCoordinateInitial.setText(String.valueOf(line.getStartPoint().getX()));
		txtyCoordinateInitial.setText(String.valueOf(line.getStartPoint().getY()));
		txtxCoordinateLast.setText(String.valueOf(line.getEndPoint().getX()));
		txtyCoordinateLast.setText(String.valueOf(line.getEndPoint().getY()));
